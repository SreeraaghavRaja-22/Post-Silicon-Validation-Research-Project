...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "pipeline_top.autotvin.dat"
	set constFileTvOut       "pipeline_top.autotvout.dat"
	set constFileHdlTvIn     "pipeline_top.autohdltvin.dat"
	set constFileHdlTvOut    "pipeline_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
