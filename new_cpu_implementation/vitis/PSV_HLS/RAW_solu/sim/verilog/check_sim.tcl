...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.pipeline_top.autotvin_reset.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.pipeline_top.autotvout_stall_out.dat"
         "rtl.pipeline_top.autotvout_forward_A_sel_out.dat"
         "rtl.pipeline_top.autotvout_forward_B_sel_out.dat"
         "rtl.pipeline_top.autotvout_hazard_dest_out.dat"
         "rtl.pipeline_top.autotvout_pc_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
