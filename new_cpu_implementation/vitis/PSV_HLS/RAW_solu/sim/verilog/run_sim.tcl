...
if {[file isfile pipeline_top.autotvin.dat]} {
	file delete -force pipeline_top.autotvin.dat
}

if {[file isfile pipeline_top.autotvout.dat]} {
	file delete -force pipeline_top.autotvout.dat
}
